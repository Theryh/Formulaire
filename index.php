        ...
        <?php 
            if(isset($_SESSION['con'])){
                if($_SESSION['con'] == "connecter"){
                    echo "<a class='w' href='formulaireconn.php'>Déconnexion</a>";
                }
            } else {
                echo "<a class='w' href='formulaireconn.php'>Connexion</a>";
            }
        ?>
...
<body>
    ...
    <form method="post" action="ajouter_message.php">
        ...
        <input type="text" name="auteur" id="idAuteur">
        <br>
    ...
    Sur le court terme, l’objectif est que chacun ait accès aux informations dont il a besoin.
          ...
          <center><table border="2" cellpadding="10" cellspacing="10">
            ...
            <caption>Les langages de programmation les plus populaire</caption>
