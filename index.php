<html>
    <head>
        <title>Evolution Call of Duty</title>
        <meta charset="UTF-8">
        <link rel="stylesheet" media="all" type="text/css" href="css/index.css">
        <meta name="robots" content="index,nofollow" />
        <meta name="description" content="Découvrez l'évolution de la franchise la plus vendu de l'histoire, de ces début jusqu'à maintenant. Du progrès à la chute. D'Activision à Microsoft">
        <title>Call of Duty: l'evolution du jeu et des polémiques d'Activision</title>
    </head>
